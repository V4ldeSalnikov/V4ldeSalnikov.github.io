...
async function main() {
  ...
  const objects = {
    bunny:  { file: "../Week5/bunny.obj",  eye: [-0.05, 0.13, 0.72], center: [-0.02, 0.09, 0.0], camConst: 3.0 },
  ...
  const envTexture = await loadImageTexture(device, "../bryanston_park_sunrise_4k.hdr.png");
  ...
  const uniforms = new Float32Array(9 * 4);
  ...
  function draw() {
    ...
    uniforms.set([
      ...
      shadingModes[shadingSelect.value], canvas.width, canvas.height, EXPOSURE,
      ...baseColor,  0.0,
