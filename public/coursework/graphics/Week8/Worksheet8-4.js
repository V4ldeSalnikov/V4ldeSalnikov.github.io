...
async function main() {
  ...
  const pipeline = device.createRenderPipeline({
    layout, vertex: vertexState, primitive,
  ...
  writeUniform(device, ubGround, viewProj, 1.0, 1.0);
  writeUniform(device, ubRed,    viewProj, 1.0, 1.0);
  ...
  function frame(timestampMs) {
    ...
    writeUniform(device, ubShadow, mult(viewProj, Ms), 0.0, 0.6);
...
function writeUniform(device, buffer, mvp, visibility, alpha) {
